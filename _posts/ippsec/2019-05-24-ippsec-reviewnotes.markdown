...
date:   2019-05-24 10:25:14 -0400
categories: ippsec
tags: ippsec
cover: /assets/images/ippsec/ippsec-logo.png
---

`Before OSCP exam`{: .info}

![OSCP-like HTB Boxes](/assets/images/ippsec/oscp-htb-labs.jpeg)
...
![ippsec-bashed-sudo](/assets/images/ippsec/ippsec-bashed-sudo.png)
...
![ippsec-sense-url](/assets/images/ippsec/ippsec-sense-url.png)

![ippsec-sense-url2](/assets/images/ippsec/ippsec-sense-url2.png)

### Nibbles

* Using `grep` searching for a specific string will lead you with a blob of data with barely readable results.

![ippsec-nibbles-grep](/assets/images/ippsec/ippsec-nibbles-grep.png)
...
![ippsec-nibbles-awk](/assets/images/ippsec/ippsec-nibbles-awk.png)
...
![ippsec-nibbles-bit](/assets/images/ippsec/ippsec-nibbles-bit.png)
...
![ippsec-nibbles-sshfwd](/assets/images/ippsec/ippsec-nibbles-sshfwd.png)
...
![heartbleed_explanation_2x](/assets/images/ippsec/heartbleed_explanation_2x.png)
...
![ippsec-poison-fileupload](/assets/images/ippsec/ippsec-poison-fileupload.png)
...
![ippsec-poison-script2](/assets/images/ippsec/ippsec-poison-script2.png)

Script is looking for '>' symbol which resulted a script error.

![ippsec-poison-script1](/assets/images/ippsec/ippsec-poison-script1.png)
...
![ippsec-devel-mspatches](/assets/images/ippsec/ippsec-devel-mspatches.png)
...
![ippsec-optimum-ping2](/assets/images/ippsec/ippsec-optimum-ping2.png)

But using `tcpdump` on an interface will monitor the ping response to verify the remote code execution is successful. 

![ippsec-optimum-ping1](/assets/images/ippsec/ippsec-optimum-ping1.png)
...
![ippsec-optimum-powershell](/assets/images/ippsec/ippsec-optimum-powershell.png)
