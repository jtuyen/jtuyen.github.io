---
title:  "Traverxec"
date:   2019-06-21 11:31:25 -0400
tags: hackthebox
cover: /assets/images/traverxec/htb-traverxec-logo.png
---
...
3. Run Metasploit and execute the vulnerability. If you see nothing on your screen, wait a few seconds for a session to establish.
	...
	![htb-traverxec-msf.png](/assets/images/traverxec/htb-traverxec-msf.png)
...
6. Cracking the hash using `hastcat` and rockyou wordlist.
	...
	![htb-traverxec-hashcat.png](/assets/images/traverxec/htb-traverxec-hashcat.png)
...
8. Enumerating the machine further, the `nhttpd.conf` file seems kind of odd, especially these lines:
	...
	![htb-traverxec-protectedarea.png](/assets/images/traverxec/htb-traverxec-protectedarea.png)
...
11. Login using the SSH private key and obtain user flag.
	...
	![htb-traverxec-userflag.png](/assets/images/traverxec/htb-traverxec-userflag.png)

12. A quick enumeration shows a script located in David's home directory.

	![htb-traverxec-serverstats.png](/assets/images/traverxec/htb-traverxec-serverstats.png)
	
	This command seems interesting:
	
	![htb-traverxec-sudojournalctl.png](/assets/images/traverxec/htb-traverxec-sudojournalctl.png)
	...
	![htb-traverxec-halfwindow.png](/assets/images/traverxec/htb-traverxec-halfwindow.png)
	...
	![htb-traverxec-rooted.png](/assets/images/traverxec/htb-traverxec-rooted.png)
