...
tags: hackthebox
cover: /assets/images/freelancer/htb-freelancer-logo.png
---
...
2.	First thing I usually do is inspect the website by clicking around and see what it does, inspect the text, links, and source code for hints. I stumbled upon a contact form that might be of interest. I tried sending some dud info and see what I can find in `burpsuite`.
	...
	![htb-freelancer-1.png](/assets/images/freelancer/htb-freelancer-1.png)

	![htb-freelancer-2.png](/assets/images/freelancer/htb-freelancer-2.png)
	...
	![htb-freelancer-3.png](/assets/images/freelancer/htb-freelancer-3.png)

	![htb-freelancer-4.png](/assets/images/freelancer/htb-freelancer-4.png)
	...
	![htb-freelancer-5.png](/assets/images/freelancer/htb-freelancer-5.png)
...
3.	Time to test for SQL injection using `sqlmap`
	...
	![htb-freelancer-6.png](/assets/images/freelancer/htb-freelancer-6.png)
	...
	![htb-freelancer-7.png](/assets/images/freelancer/htb-freelancer-7.png)
	...
	![htb-freelancer-8.png](/assets/images/freelancer/htb-freelancer-8.png)

	![htb-freelancer-9.png](/assets/images/freelancer/htb-freelancer-9.png)
	...
	![htb-freelancer-10.png](/assets/images/freelancer/htb-freelancer-10.png)
...
4.	Seeing that this is `bcrypt` hash is unbreakable. Time to go back to enumerate the website since I haven't done it yet. If it made you wonder why I didn't do this at the beginning, I usually roam through the website and source code for hidden links or comments that may give clues.
	...
	![htb-freelancer-11.png](/assets/images/freelancer/htb-freelancer-11.png)
	...
	![htb-freelancer-12.png](/assets/images/freelancer/htb-freelancer-12.png)

	Let's see what files I can find inside `/administrat`.
	
	![htb-freelancer-13.png](/assets/images/freelancer/htb-freelancer-13.png)
...
5.	After taking a look around once again and figuring out my next steps, I decided to take a look at what database privileges I have using SQL injection. 
	...
	![htb-freelancer-14.png](/assets/images/freelancer/htb-freelancer-14.png)
...
7.	Not sure what I needed to do here, I decided to see what kind of files I can read on the system itself. Since `panel.php` was acting a bit strange with the redirection, I wonder if there was hidden code inside the php file.
	...
	![htb-freelancer-15.png](/assets/images/freelancer/htb-freelancer-15.png)