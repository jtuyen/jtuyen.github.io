---
title:  "Monteverde"
date:   2020-03-28 11:31:25 -0400
tags: hackthebox
cover: /assets/images/monteverde/htb-monteverde-logo.png
---
...
7.	Running low on the number of enumerations, I've resorted to brute forcing the SMB accounts. After numerous attempts of brute forcing various accounts, I found one that works: `MEGABANK\SABatchJobs:SABatchJobs`
	...
	![htb-monteverde-1.png](/assets/images/monteverde/htb-monteverde-1.png)

8.	I re-ran `smbmap` again using the new credentials and found a listing of files and folders.

	![htb-monteverde-2.png](/assets/images/monteverde/htb-monteverde-2.png)
...
9.	Used `smbclient` to enumerate what is inside users folders and an `azure.xml` item stood out. Upon reading the file, it contained a password which I'm not sure what can be used for yet.
	...
	![htb-monteverde-3.png](/assets/images/monteverde/htb-monteverde-3.png)
	
	![htb-monteverde-4.png](/assets/images/monteverde/htb-monteverde-4.png)
	
	![htb-monteverde-5.png](/assets/images/monteverde/htb-monteverde-5.png)
	
	Logon credentials has been found: `mhope:4n0therD4y@n0th3r$`
	
	I tested the credentials to verify samba access.
	
	![htb-monteverde-6.png](/assets/images/monteverde/htb-monteverde-6.png)
...
11. I used `evil-winrm` to gain remote access on port 5985 and the user flag has been obtained.
	...
	![htb-monteverde-7.png](/assets/images/monteverde/htb-monteverde-7.png)
	
	![htb-monteverde-8.png](/assets/images/monteverde/htb-monteverde-8.png)

### Privilege Escalation

1.	After digging around looking for clues inside the system, I found a hidden Azure directory.

	![htb-monteverde-9.png](/assets/images/monteverde/htb-monteverde-9.png)
	...
	![htb-monteverde-10.png](/assets/images/monteverde/htb-monteverde-10.png)
	
	![htb-monteverde-11.png](/assets/images/monteverde/htb-monteverde-11.png)

	Let's try and download the `TokenCache.dat` and inspect what is inside.
	
	![htb-monteverde-12.png](/assets/images/monteverde/htb-monteverde-12.png)
	
	![htb-monteverde-13.png](/assets/images/monteverde/htb-monteverde-13.png)
	...
	![htb-monteverde-14.png](/assets/images/monteverde/htb-monteverde-14.png)
	
	![htb-monteverde-15.png](/assets/images/monteverde/htb-monteverde-15.png)
	
	Looks like it has been connected to Azure at some point of time.
	
	![htb-monteverde-16.png](/assets/images/monteverde/htb-monteverde-16.png)
	
	It doesn't look too hopeful at the moment to be exploiting a real Azure environment.
	
	![htb-monteverde-17.png](/assets/images/monteverde/htb-monteverde-17.png)
...
2.	Token cache data is empty hence why you can't connect to Azure. At least I learned something about the process of Azure enumeration.
	...
	![htb-monteverde-18.png](/assets/images/monteverde/htb-monteverde-18.png)
...
4.	After googling some more, I came upon another [script](https://vbscrub.video.blog/2020/01/14/azure-ad-connect-database-exploit-priv-esc/) that was related and has the ability to enumerate all databases.
	...
	![htb-monteverde-19.png](/assets/images/monteverde/htb-monteverde-19.png)
	
	![htb-monteverde-20.png](/assets/images/monteverde/htb-monteverde-20.png)
	
5.	Using the discovered Administrator credential, using `evil-winrm` again, I was able to obtain the `root.txt` flag.
	
	![htb-monteverde-21.png](/assets/images/monteverde/htb-monteverde-21.png)
