...
tags: hackthebox
cover: /assets/images/cartographer/htb-cartographer-logo.png
---
...
2.  Playing around with it, invalid parameters show `page not found` error. I wonder if I could fuzz the URL and see if there are possible pages that can be found using a word list.
    ...
    ![htb-cartographer-cookie.png](/assets/images/cartographer/htb-cartographer-cookie.png)

    Now we pass this cookie information to the `wfuzz` command.

    ![htb-cartographer-urlfuzz.png](/assets/images/cartographer/htb-cartographer-urlfuzz.png)
